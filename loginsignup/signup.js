...
$(document).ready(function () {
    ...
    $("#contact-list").on("click", ".update", function (e) {
      ...
      let contactPassword = $(this).data("pass");
    ...
    $("#update-contact-submit").on("click", function (e) {
      ...
      let contactPassword = $("#update-contact-pass").val();
    ...
    function updateForm(id, contactName, contactEmail, contactPassword) {
      ...
      var settings = {
        "async": true,
        "crossDomain": true,
        "url": `https://github.com/S10242414/S10242414.github.io.git/contact/${id}`,//update based on the ID
        "method": "PUT",
        "headers": {
          "content-type": "application/json",
          "x-apikey": "63d565e83bc6b255ed0c43c7",
